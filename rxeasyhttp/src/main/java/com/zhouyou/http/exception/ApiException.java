...
public class ApiException extends Exception {
    ...
    public static class ERROR {
         ...
         * 解析错误
         */
        public static final String PARSE_ERROR = UNKNOWN + 1;
        /**
         * 网络错误
         */
        public static final String NETWORD_ERROR = PARSE_ERROR + 1;
        /**
         * 协议出错
         */
        public static final String HTTP_ERROR = NETWORD_ERROR + 1;

        /**
         * 证书出错
         */
        public static final String SSL_ERROR = HTTP_ERROR + 1;

        /**
         * 连接超时
         */
        public static final String TIMEOUT_ERROR = SSL_ERROR + 1;

        /**
         * 调用错误
         */
        public static final String INVOKE_ERROR = TIMEOUT_ERROR + 1;
        /**
         * 类转换错误
         */
        public static final String CAST_ERROR = INVOKE_ERROR + 1;
        /**
         * 请求取消
         */
        public static final String REQUEST_CANCEL = CAST_ERROR + 1;
        /**
         * 未知主机错误
         */
        public static final String UNKNOWNHOST_ERROR = REQUEST_CANCEL + 1;

        /**
         * 空指针错误
         */
        public static final String NULLPOINTER_EXCEPTION = UNKNOWNHOST_ERROR + 1;
    }
}